...
//	Query
	...
	///echo $sql 	= "select distinct a.jobline, d.point, d.partnumber, a.jobmodelname,
	...
	$sql	= "select * from search_partno2('".$src_jobno."','".$src_partno."','".$src_model."','".$src_sdate."','".$src_edate."')";
	$rs		= $db->Execute($sql);
