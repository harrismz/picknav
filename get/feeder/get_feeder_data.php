...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(	operator == "2_install_data"){
			//remove
			$("#dt_installdata").removeClass("partnoClick-table pickingClick-table installClick-table checkedClick-table replaceClick-table limitClick-table criticalClick-table");
			//add
			$("#dt_installdata").addClass("criticalClick-table");
		}
		return false;
    });
</script>
