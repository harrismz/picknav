...
if($exist == 0){ echo'<h4 class="warning" align="center" style="color: red;">No Loading List Data</h4>'; }
    ...
    echo'<table id="dt_zfeed" class="table table-striped dt_zfeed table-hover col-xs-12 col-sm-12 col-md-12 col-lg-12">';
		...
		while(!$rs1->EOF){
            ...
            if($sts_opstart2 === "1"){ echo'<tr style="background-color:yellow !important">'; }
			elseif($sts_opstart2 === "2"){ echo'<tr style="background-color:lightgreen !important">'; }
			elseif($sts_opstart2 === "4"){ echo'<tr style="background-color:lightblue !important">'; }
			elseif($sts_opstart2 == ""){ echo'<tr>'; }
				...
				echo'<td data-content="PIC" id="select_pic">'.$opname.'</td>';
            echo'</tr>';
			$rs1->MoveNext();
		}
	echo'</tbody>';
